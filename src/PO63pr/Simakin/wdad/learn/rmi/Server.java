...
public class Server {
    static final String FILEPATH = "C:\\Users\\PSYSHO\\Desktop\\РВПРС\\starting-monkey-to-human-path\\src\\PO63pr\\Simakin\\wdad\\learn\\xml\\CF\\Test.xml";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            DataManager stub = (DataManager) UnicastRemoteObject.exportObject((Remote) obj, 0);
            Registry registry;
            ...
            registry.bind("DataManager", (Remote) obj);
